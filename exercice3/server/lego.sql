...
--
-- Hôte : localhost:8889
-- Généré le : dim. 26 fév. 2023 à 19:20
...
INSERT INTO `Lego_Collection` (`id`, `collection`) VALUES
(1, 'Creator Expert'),
(2, 'Creator'),
(3, 'Star Wars'),
(4, 'Harry Potter');
...
--
-- Structure de la table `Lego_Set`
--
...
CREATE TABLE `Lego_Set` (
  ...
  `idcollection` int(11) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Déchargement des données de la table `Lego_Set`
--

INSERT INTO `Lego_Set` (`id`, `name`, `description`, `price`, `pieces`, `imagebox`, `imagebg`, `idcollection`) VALUES
...
--
-- Index pour la table `Lego_Set`
--
ALTER TABLE `Lego_Set`
  ADD PRIMARY KEY (`id`),
  ADD KEY `collection` (`idcollection`);
...
--
-- Contraintes pour la table `Lego_Set`
--
ALTER TABLE `Lego_Set`
  ADD CONSTRAINT `lego_set_ibfk_1` FOREIGN KEY (`idcollection`) REFERENCES `Lego_Collection` (`id`);
COMMIT;
